...
Comppass.StatsTable = function(data_long){
  ...
  stats_tab  # average spectral counts for each bait-prey pair
}
...
Comppass.main = function(data_file, output_file, resampling=F){
  cat("\tREADING\n")
  data = read.delim("/Users/swati/Desktop/Tk-interactome-summary-analysis/All-data-compass-runs-160722/Comppass-runs-160726/Compass-runs-union-proteincount-selfpickbait-160808/compass-run/compass-matrix-modified-noselfIps.T",  stringsAsFactors=F, header=T,skip=1, check.names=FALSE)
  cat("\tCONVERTING\n")
  ...
  cat("\tCOMPUTING STATS\n")
  ## make stats table   stats table is the average spectral counts between each bait-prey 
  stats_tab = Comppass.StatsTable(data_long)
  write.table(stats_tab, file="/Users/swati/Desktop/Tk-interactome-summary-analysis/All-data-compass-runs-160722/Comppass-runs-160726/Compass-runs-union-proteincount-selfpickbait-160808/compass-run/stats_tab" , sep="\t")
  
  ## make reproducibility table
  repro_tab = Comppass.ReproTable(data_long)
   write.table(repro_tab, file="/Users/swati/Desktop/Tk-interactome-summary-analysis/All-data-compass-runs-160722/Comppass-runs-160726/Compass-runs-union-proteincount-selfpickbait-160808/compass-run/repro_tab", sep="\t")
  
  ## make specificity table
  speci_tab = Comppass.SpeciTable(stats_tab)
  write.table(speci_tab, file="/Users/swati/Desktop/Tk-interactome-summary-analysis/All-data-compass-runs-160722/Comppass-runs-160726/Compass-runs-union-proteincount-selfpickbait-160808/compass-run/speci_tab", sep="\t")
  ...
  cat("\tWRITING\n")
  ## write out
  write.table(summary, file="/Users/swati/Desktop/Tk-interactome-summary-analysis/All-data-compass-runs-160722/Comppass-runs-160726/Compass-runs-union-proteincount-selfpickbait-160808/compass-run/output_file", row.names=F, col.names=T, eol="\n", sep="\t", quote=F) 
  return(summary)
}

c=Comppass.main(data_file, output_file, resampling=F)
write.table (c, file="/Users/swati/Desktop/Tk-interactome-summary-analysis/All-data-compass-runs-160722/Comppass-runs-160726/Compass-runs-union-proteincount-selfpickbait-160808/compass-run/summary", sep="\t")
